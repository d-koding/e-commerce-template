  ...
  return (
    <div className='flex flex-col gap-6'>
        ...
        <ul className='flex items-center gap-4'>
            <li className='w-8 h-8 rounded-full ring-1 ring-gray-300 cursor-pointer relative bg-primary'>
        ...
        <ul className='flex items-center gap-3'>
            ...
            <li className='ring-1 ring-primary bg-primary text-white rounded-md py-1 px-4 text-sm cursor-pointer'>
                Medium
            </li>
