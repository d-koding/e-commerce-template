    ...
    {!cartItems ? (
        ...
        <div className='flex flex-col gap-8'>
            ...
            <div className="flex gap-4">
                <Image
                src="https://images.pexels.com/photos/279626/pexels-photo-279626.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" 
                alt="" 
                width={72} 
                height={96} 
            ...
            <div className='flex flex-col justify-between w-full'>
                ...
                <div className=''>
                    ...
                    <div className='flex items-center justify-between gap-8'>
                        ...
                        <div className='p-1 bg-gray-50 round-sm'>$47</div>  
                    </div>
                    {/* DESC */}
